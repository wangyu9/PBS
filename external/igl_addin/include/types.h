...
//typedef Eigen::Matrix<unsigned int, Eigen::Dynamic, Eigen::Dynamic > TetMatrixType;//added by wangyu
//typedef Eigen::Matrix<ScalarType, Eigen::Dynamic, 2, Eigen::RowMajor> UVMatrixType;

typedef Eigen::MatrixXd PointMatrixType;
typedef Eigen::MatrixXi FaceMatrixType;
typedef Eigen::MatrixXi TetMatrixType;
typedef Eigen::MatrixXd UVMatrixType;
