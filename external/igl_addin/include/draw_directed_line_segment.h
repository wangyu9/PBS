#ifndef IGL_ADDIN_DRAW_DIRECTED_LINE_SEGMENT_H
#define IGL_ADDIN_DRAW_DIRECTED_LINE_SEGMENT_H
...
inline void draw_directed_line_segment2(
	double sx,
	double sy,
	double sz,
	double dx,
	...
	bool with_depth)
{
	...
	(with_depth)?glEnable(GL_DEPTH_TEST):glDisable(GL_DEPTH_TEST);
	glDisable(GL_LIGHTING);
	glDisable(GL_LINE_STIPPLE);
