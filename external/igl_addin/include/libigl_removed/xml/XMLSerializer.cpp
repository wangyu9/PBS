...
void EncodeXMLElementName(std::string& name)
{
	...
	for (int i = 0; i<numForbiddenChars; i++)
	{
		...
		igl::ReplaceSubString(name, search, replace);//wangyu
	}
}
...
//template<typename T>
//static bool XMLSerializer::SaveObject(T& object, const char* filename)//wangyu
//{
//	return SaveObject(object, "Object", "Serialization", filename, true);
//}
//
//template<typename T>
//static bool XMLSerializer::SaveObject(T& object, const std::string& objectName, const std::string& groupName, const char* filename, bool overwrite)//wangyu
//{
//	bool result = true;
...
//
//template<typename T>
//static bool XMLSerializer::LoadObject(T& object, const char* filename)
//{
//	return LoadObject(object, "Object", "Serialization", filename);
//}
//
//template<typename T>
//static bool XMLSerializer::LoadObject(T& object, const std::string& objectName, const std::string& groupName, const char* filename)
//{
//	bool result = true;
//	XMLSerializer* serializer = new XMLSerializer(groupName);
//	result &= serializer->Add(object, objectName);
