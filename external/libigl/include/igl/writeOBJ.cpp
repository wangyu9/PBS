...
// wangyu
template bool igl::writeOBJ<class Eigen::Matrix<double, -1, 3, 1, -1, 3>, class Eigen::Matrix<unsigned int, -1, -1, 1, -1, -1> >(class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char> >, class Eigen::PlainObjectBase<class Eigen::Matrix<double, -1, 3, 1, -1, 3> > const &, class Eigen::PlainObjectBase<class Eigen::Matrix<unsigned int, -1, -1, 1, -1, -1> > const &);
