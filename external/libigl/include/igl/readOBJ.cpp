...
//wangyu
//template bool igl::readOBJPoly<class Eigen::Matrix<double, -1, 3, 1, -1, 3>, class Eigen::Matrix<unsigned int, -1, -1, 1, -1, -1>, class Eigen::Matrix<double, -1, 2, 1, -1, 2>, unsigned int>(class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char> >, class Eigen::PlainObjectBase<class Eigen::Matrix<double, -1, 3, 1, -1, 3> > &, class std::vector<class std::vector<unsigned int, class std::allocator<unsigned int> >, class std::allocator<class std::vector<unsigned int, class std::allocator<unsigned int> > > > &, class Eigen::PlainObjectBase<class Eigen::Matrix<double, -1, 3, 1, -1, 3> > &, class Eigen::PlainObjectBase<class Eigen::Matrix<unsigned int, -1, -1, 1, -1, -1> > &, class Eigen::PlainObjectBase<class Eigen::Matrix<double, -1, 2, 1, -1, 2> > &, class Eigen::PlainObjectBase<class Eigen::Matrix<unsigned int, -1, -1, 1, -1, -1> > &);
template bool igl::readOBJ<class Eigen::Matrix<double, -1, -1, 0, -1, -1>, class Eigen::Matrix<unsigned int, -1, -1, 1, -1, -1> >(class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char> >, class Eigen::PlainObjectBase<class Eigen::Matrix<double, -1, -1, 0, -1, -1> > &, class Eigen::PlainObjectBase<class Eigen::Matrix<unsigned int, -1, -1, 1, -1, -1> > &);
template bool igl::readOBJ<class Eigen::Matrix<double, -1, 3, 1, -1, 3>, class Eigen::Matrix<unsigned int, -1, -1, 1, -1, -1>, class Eigen::Matrix<double, -1, 2, 1, -1, 2> >(class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char> >, class Eigen::PlainObjectBase<class Eigen::Matrix<double, -1, 3, 1, -1, 3> > &, class Eigen::PlainObjectBase<class Eigen::Matrix<double, -1, 2, 1, -1, 2> > &, class Eigen::PlainObjectBase<class Eigen::Matrix<double, -1, 3, 1, -1, 3> > &, class Eigen::PlainObjectBase<class Eigen::Matrix<unsigned int, -1, -1, 1, -1, -1> > &, class Eigen::PlainObjectBase<class Eigen::Matrix<unsigned int, -1, -1, 1, -1, -1> > &, class Eigen::PlainObjectBase<class Eigen::Matrix<unsigned int, -1, -1, 1, -1, -1> > &);
#endif
