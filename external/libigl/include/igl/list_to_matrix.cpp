...
// Explicit template specialization by wangyu
template bool igl::list_to_matrix<unsigned __int64, class Eigen::PlainObjectBase<class Eigen::Matrix<int, -1, 1, 0, -1, 1> > >(class std::vector<unsigned __int64, class std::allocator<unsigned __int64> > const &, class Eigen::PlainObjectBase<class Eigen::Matrix<int, -1, 1, 0, -1, 1> > &);
template bool igl::list_to_matrix<unsigned int, class Eigen::PlainObjectBase<class Eigen::Matrix<unsigned int, -1, -1, 1, -1, -1> > >(class std::vector<class std::vector<unsigned int, class std::allocator<unsigned int> >, class std::allocator<class std::vector<unsigned int, class std::allocator<unsigned int> > > > const &, class Eigen::PlainObjectBase<class Eigen::Matrix<unsigned int, -1, -1, 1, -1, -1> > &);
