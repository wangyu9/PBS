...
//wangyu
template void igl::per_vertex_normals<class Eigen::Matrix<double, -1, 3, 1, -1, 3>, class Eigen::Matrix<unsigned int, -1, -1, 1, -1, -1>, class Eigen::Matrix<double, -1, 3, 1, -1, 3>, class Eigen::Matrix<double, -1, 3, 1, -1, 3> >(class Eigen::PlainObjectBase<class Eigen::Matrix<double, -1, 3, 1, -1, 3> > const &, class Eigen::PlainObjectBase<class Eigen::Matrix<unsigned int, -1, -1, 1, -1, -1> > const &, enum igl::PerVertexNormalsWeightingType, class Eigen::PlainObjectBase<class Eigen::Matrix<double, -1, 3, 1, -1, 3> > const &, class Eigen::PlainObjectBase<class Eigen::Matrix<double, -1, 3, 1, -1, 3> > &);
