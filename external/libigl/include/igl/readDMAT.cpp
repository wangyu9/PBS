...
{
  FILE * fp = fopen(file_name.c_str(),"r");// wangyu changed from "rb" to "r", http://stackoverflow.com/questions/2174889/whats-the-differences-between-r-and-rb-in-fopen
  if(fp == NULL)
  {
...
//wangyu
template bool igl::readDMAT<class Eigen::Matrix<double, -1, 3, 1, -1, 3> >(class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char> >, class Eigen::PlainObjectBase<class Eigen::Matrix<double, -1, 3, 1, -1, 3> > &);
