...
//wangyu
template bool igl::writeDMAT<class Eigen::Matrix<double, -1, 3, 1, -1, 3> >(class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char> >, class Eigen::Matrix<double, -1, 3, 1, -1, 3> const &, bool);
template bool igl::writeDMAT<class Eigen::Matrix<unsigned int, -1, -1, 0, -1, -1> >(class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char> >, class Eigen::Matrix<unsigned int, -1, -1, 0, -1, -1> const &, bool);
