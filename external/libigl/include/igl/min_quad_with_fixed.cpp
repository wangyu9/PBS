...
//#define MIN_QUAD_WITH_FIXED_CPP_DEBUG
  ...
  //wangyu assert(Auu.size() > 0 && "There should be at least one unknown.");//wangyu removed this to allow all constrained
  ...
  if(data.Auu_pd)
  {
    ...
    //assert(is_symmetric(Auu,1.0) && 
     // "Auu should be symmetric if positive definite");//wangyu removed this to allow all constrained
  }else
  {
...
//wangyu
//template bool igl::min_quad_with_fixed_solve<double, class Eigen::Matrix<double, -1, -1, 0, -1, -1>, class Eigen::Matrix<double, -1, -1, 0, -1, -1>, class Eigen::Matrix<double, -1, 1, 0, -1, 1>, class Eigen::Matrix<double, -1, -1, 0, -1, -1> >(struct igl::min_quad_with_fixed_data<double> const &, class Eigen::PlainObjectBase<class Eigen::Matrix<double, -1, -1, 0, -1, -1> > const &, class Eigen::PlainObjectBase<class Eigen::Matrix<double, -1, -1, 0, -1, -1> > const &, class Eigen::PlainObjectBase<class Eigen::Matrix<double, -1, 1, 0, -1, 1> > const &, class Eigen::PlainObjectBase<class Eigen::Matrix<double, -1, -1, 0, -1, -1> > &);
template bool igl::min_quad_with_fixed_solve<double, class Eigen::Matrix<double, -1, -1, 0, -1, -1>, class Eigen::Matrix<double, -1, -1, 0, -1, -1>, class Eigen::Matrix<double, -1, -1, 0, -1, -1>, class Eigen::Matrix<double, -1, -1, 0, -1, -1> >(struct igl::min_quad_with_fixed_data<double> const &, class Eigen::PlainObjectBase<class Eigen::Matrix<double, -1, -1, 0, -1, -1> > const &, class Eigen::PlainObjectBase<class Eigen::Matrix<double, -1, -1, 0, -1, -1> > const &, class Eigen::PlainObjectBase<class Eigen::Matrix<double, -1, -1, 0, -1, -1> > const &, class Eigen::PlainObjectBase<class Eigen::Matrix<double, -1, -1, 0, -1, -1> > &);
#endif
