...
void YImage::resize( int widthh, int heightt )
{
	...
	if( m_data )
	{
		int min_width = (m_width < widthh)? m_width : widthh;//wangyu int min_width = std::min( m_width, widthh ) ;
		int min_height = (m_height < heightt)? m_height : heightt;//wangyu int min_height = std::min( m_height, heightt ) ;
