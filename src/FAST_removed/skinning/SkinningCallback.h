...
namespace SkinningCallback
{
  ...
  // Sets and gets draw_bones_according_to_T being sure to tell each bone
  void TW_CALL set_draw_bones_according_to_T(const void *value, void *clientData);
  void TW_CALL get_draw_bones_according_to_T(void *value, void *clientData);
  void TW_CALL set_draw_connected_skeleton(const void *value, void *clientData);
  void TW_CALL get_draw_connected_skeleton(void *value, void *clientData);
  void TW_CALL set_average_children_tails_to_draw_non_weighted_roots(const void *value, void *clientData);
  void TW_CALL get_average_children_tails_to_draw_non_weighted_roots(void *value, void *clientData);
  ...
  void TW_CALL set_view_vector(const void *value, void *clientData);
  void TW_CALL get_view_vector(void *value, void *clientData);
  ...
  void TW_CALL set_use_corner_normals(const void *value, void *clientData);
  void TW_CALL get_use_corner_normals(void *value, void *clientData);
