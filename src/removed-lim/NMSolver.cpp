...
int NMSolver::solve()
{
  ...
  if(true)
  {
	  //this is the original solver in LIM paper
  ...
  {
	  //wangyu change this to the very fundamental Newton Method
	  //prevSolution = solution;
	  //solution = prevSolution - hessian\gradient;
  }


  timerWrapper.Toc();
  printf("NM solver time: %f\n",timerWrapper.Duration());
